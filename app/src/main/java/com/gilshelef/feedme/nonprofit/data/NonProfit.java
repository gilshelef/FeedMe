...
public class NonProfit {
    ...
    private void alertAuthorized(Context context) {
        Intent intent = new Intent(context, NonProfitMainActivity.class);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setContentTitle(context.getString(R.string.authrization_confimed))
                .setContentText(context.getString(R.string.authrization_confimed_msg))
                .setAutoCancel(true)
